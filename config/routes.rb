Myapp::Application.routes.draw do
  ...
  resources :not_published_opinions
  resources :users
  resources :photo_in_events
  resources :photo_in_slayders
  resources :photo_in_articles
  resources :tents
  ...
  get "articles/:id/prosmotr",to:'articles#beauty'
  get "events/:id/prosmotr", to:'events#beauty'
  get "category_events/:id/prosmotr", to:'category_events#beauty'

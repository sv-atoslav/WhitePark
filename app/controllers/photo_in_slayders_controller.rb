class PhotoInSlaydersController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @photo_in_slayder.save
        format.html { redirect_to @photo_in_slayder, notice: 'Photo in slayder was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @photo_in_slayder.update(photo_in_slayder_params)
        format.html { redirect_to @photo_in_slayder, notice: 'Photo in slayder was successfully updated.' }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to photo_in_slayders_url, notice: 'Photo in slayder was successfully destroyed.' }

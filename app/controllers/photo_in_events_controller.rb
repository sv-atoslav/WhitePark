class PhotoInEventsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @photo_in_event.save
        format.html { redirect_to @photo_in_event, notice: 'Photo in event was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @photo_in_event.update(photo_in_event_params)
        format.html { redirect_to @photo_in_event, notice: 'Photo in event was successfully updated.' }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to photo_in_events_url, notice: 'Photo in event was successfully destroyed.' }

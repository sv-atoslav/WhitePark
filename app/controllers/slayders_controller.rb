class SlaydersController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @slayder.save
        format.html { redirect_to @slayder, notice: 'Slayder was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @slayder.update(slayder_params)
        format.html { redirect_to @slayder, notice: 'Slayder was successfully updated.' }
  ...
  def destroy
    @slayder.destroy
    respond_to do |format|
      format.html { redirect_to slayders_url, notice: 'Slayder was successfully destroyed.' }

class NotPublishedOpinionsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @not_published_opinion.save
        ...
        format.html { redirect_to "//localhost:3000/otzivi" , notice: 'Not published opinion was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @not_published_opinion.update(not_published_opinion_params)
        format.html { redirect_to @not_published_opinion, notice: 'Not published opinion was successfully updated.' }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to not_published_opinions_url, notice: 'Not published opinion was successfully destroyed.' }

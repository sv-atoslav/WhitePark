class PhotoInArticlesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @photo_in_article.save
        format.html { redirect_to @photo_in_article, notice: 'Photo in article was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @photo_in_article.update(photo_in_article_params)
        format.html { redirect_to @photo_in_article, notice: 'Photo in article was successfully updated.' }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to photo_in_articles_url, notice: 'Photo in article was successfully destroyed.' }

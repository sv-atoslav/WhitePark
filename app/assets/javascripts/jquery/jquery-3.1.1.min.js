...
("undefined"!=typeof window?window:this,function(a,b){
	...
	r.each("Boolean Number String Function Array Date RegExp Object Error Symbol".split(" "),function(a,b){j["[object "+b+"]"]=b.toLowerCase()});
	function w(a){
	...
	G=r.fn.init=function(a,b,c){
		...
		r.each(
			...
			function(a,b){
				r.fn[a]=function(a,c,d){return this.animate(b,a,c,d)}
			}
		),
		...
		function(){
			...
			r.extend({attr:function(a,b,c){var d,e,f=a.nodeType;if(3!==f&&8!==f&&2!==f)return"undefined"==typeof a.getAttribute?r.prop(a,b,c):(1===f&&r.isXMLDoc(a)||(e=r.attrHooks[b.toLowerCase()]||(r.expr.match.bool.test(b)?ib:void 0)),
